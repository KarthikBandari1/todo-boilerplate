...
{
    public abstract class todo3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static todo3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(todo3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<todo3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<todo3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<todo3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<todo3DbContext, Task<T>> func)
        {
            T result;
